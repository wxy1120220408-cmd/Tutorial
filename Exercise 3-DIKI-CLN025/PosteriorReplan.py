    ...
    def train_step(x_batch_train, y_batch_train, centers, lam=1.):
        with tf.GradientTape() as tape:
            ...
            train_loss = 1*keras.losses.MeanSquaredError()(y_batch_train, predict)\
                       + 1*keras.losses.MeanSquaredError()(hidden,centers)\
                       + lam*kl_loss
...
def init_estimator(min_cluster_size=10000, min_samples=100, sigma=0, cluster_selection_method='eom',core_dist_n_jobs=8):
